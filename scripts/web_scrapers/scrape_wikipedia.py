...
Wikipedia pages (Pittsburgh, History of Pittsburgh).
...
SCRAPE_OPTIONS = {
    ...
    "excludeTags": ["nav", "footer", "aside", ".mw-editsection"],
    "waitFor": 1000,
}
...
def scrape_url(url: str, api_key: str) -> dict:
    ...
    response = requests.post(f"{BASE_URL}/scrape", headers=headers, json=payload, timeout=60)
